...
定义于： [packages/query-core/src/types.ts:1033](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L1033)
...
| <a id="isplaceholderdata"></a> `isPlaceholderData` | `true` | 当前显示的是占位数据时为 `true`。 | [`QueryObserverBaseResult`](QueryObserverBaseResult.md).[`isPlaceholderData`](QueryObserverBaseResult.md#isplaceholderdata) |
