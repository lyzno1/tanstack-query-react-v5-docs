...
定义于： [packages/query-core/src/types.ts:1001](https://github.com/TanStack/query/blob/main/packages/query-core/src/types.ts#L1001)
...
| <a id="isrefetcherror"></a> `isRefetchError` | `true` | 查询重新获取失败时为 `true`。 | [`QueryObserverBaseResult`](QueryObserverBaseResult.md).[`isRefetchError`](QueryObserverBaseResult.md#isrefetcherror) |
